...
research the model, assemble its `models.yaml` entry, verify it with `run-model`, and iterate on
...
- Confirm the entry by actually running it, not by reasoning alone.
