...
// Drizzle proxy DB that captures real SQL and params generated by the ORM.
// Tests assert against the captured queries so they stay resilient to
// column-order changes and are not coupled to internal mock shapes.
