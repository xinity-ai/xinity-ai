...
export const dashboardEnvSchema = z.object({
  ...
  PROMETHEUS_URL: z.url().optional().describe("Prometheus server URL for live GPU metrics overlay on the fleet page (e.g. http://prometheus:9090). Enables utilization rings and energy readouts on compute nodes.").meta(expert()),
});
